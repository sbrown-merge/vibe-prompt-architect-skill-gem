...
|---|---|---|
| SKILL.md | 2.22.0 (YAML comment + italic byline under H1) | 2026-06-05 |
| vibe-prompt-architect-gem.md (router) | No internal marker (tracked by git/CHANGELOG; project version 2.22.0) | 2026-06-05 |
| vibe-prompt-architect-knowledge.md | 2.22.0 | 2026-06-05 |
