...
- [ ] Phase 2 flag section in both files — content and dependency-chain position (States/Navigation after CTA; Theming after the token authority, before Accessibility; Conflict Check last, before AC)
